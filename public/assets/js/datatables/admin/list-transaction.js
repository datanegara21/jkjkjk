...
var KTDatatableJsonRemoteDemo = function() {
    ...
    var demo = function() {
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            data: {
                type: 'remote',
                source: HOST_URL + '/transaction/data',
                pageSize: 10,
            },
            ...
            columns: [{
                ...
                template: function(data, index) {
                    var status = {
                        ...
                        'pending': {
                            'class': ' symbol-light-warning',
                        },
                        'deny': {
                            'class': ' symbol-light-danger',
                        },
                        'cancel': {
                            'class': ' symbol-light-danger',
                        },
                    ...
                    index++
                    return '<span class="symbol symbol-35 '+status[data.status].class+'"><span class="symbol-label font-size-h5 font-weight-bold">'+index+'</span></span>'
                }
            }, {
                field: 'title',
                title: 'Pembayaran',
                ...
                template: function(data) {
                    return '<span class="text-dark font-weight-bold">'+data.title+'</span>'
                }
                ...
                width: 130,
                template: function(data) {
                    return '<span class="text-dark">'+data.order_id+'</span>'
                }
                ...
                autoHide: false,
                template: function(data) {
                    var angka = data.gross_amount.replace('.00','')
                    ...
                    return '<span class="text-dark">Rp'+price+'</span>'
                }
            }, {
                field: 'created_at',
                title: 'Tanggal',
                template: function(data) {
                    ...
                    return '<span class="text-dark">'+date.getDate()+'/'+date.getMonth()+'/'+date.getFullYear()+' '+date.getHours()+':'+date.getMinutes()+'</span>'
                }
            }, {
                field: 'payment_type',
                title: 'Tipe Pembayaran',
                template: function(data) {
                    return '<span class="text-dark">'+data.payment_type+'</span>'
                }
            }, {
                field: 'status',
                title: 'Status',
