                ...
                <div class="card card-custom">
                    <div class="card-header flex-wrap border-0 pt-6 pb-0">
                        <div class="card-title">
                            <h3 class="card-label">
                                Transaksi <span class="text-muted">| {{ $payments->count() }} data transaksi</span>
                            </h3>
                        </div>
                                        ...
                                        <div class="col-md-4 my-2 my-md-0">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <select class="form-control" id="kt_datatable_search_status">
                                                    ...
                                                    <option value="capture">Ditangkap</option>
...
@push('style')
    ...
    @push('script')
        ...
        <script src="{{ asset('assets/js/datatables/admin/list-transaction.js?v=7.0.6') }}"></script>
    @endpush
