        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Hapus event {{ $event->title }}</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <i aria-hidden="true" class="ki ki-close"></i>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div>Apakah anda yakin ingin menghapus event ini?</div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-light-primary font-weight-bold" data-dismiss="modal">Batal</button>
                        <a href="{{ url('event/delete/'.$event->id) }}" class="btn btn-primary font-weight-bold" disabled>Hapus</a>
                    </div>
                </form>
            </div>
        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="card card-custom">
                        ...
                        <div class="flex-row-fluid ml-lg-8">
                            <!--begin::Form-->
                            <form class="form" action="{{ url('event/edit/'.$event->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="card card-custom card-stretch">
                                    ...
                                    <div class="card-header py-3">
                                        ...
                                        <div class="card-toolbar">
                                            <a data-toggle="modal" data-target="#deleteModal" class="btn btn-danger mr-2">Hapus</a>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <input class="form-control form-control-lg form-control-solid"
                                                    type="text" name="name" value="{{ $event->name }}" placeholder="{{ Auth::user()->name }}" required/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-xl-3"></label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg form-control-solid" name="title" value="{{ $event->title }}" placeholder="Event yang akan diselenggarakan" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    <input type="file" class="form-control form-control-lg form-control-solid" name="image" nullable/>
                                                </div>
                                                <img src="{{ $event->image ? asset($event->image) : asset($event->event_template->event_category->image) }}" alt="Gambar" width="100%">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <textarea name="description" class="form-control form-control-lg form-control-solid" placeholder="Deskripsi tentang event yang akan diselenggarakan" cols="30" rows="2" required>{{ $event->description }}</textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group input-group-lg input-group-solid" id="kt_datetimerangepicker_1">
                                                    ...
                                                    <input type="text" name="date" class="form-control form-control-lg form-control-solid" value="{{ $event->date }}" placeholder="01/01/2022 00:05 - 31/12/2022 23:55" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" name="location"
                                                        ...
                                                        placeholder="Jl. Mawar, Ds. Melati" value="{{ $event->location }}" required/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                ...
                                                <input type="hidden" name="map"  id="latlng" value="{{ $event->map }}" required/>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <label class="col-xl-3"></label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group input-group-lg input-group-solid">
                                                    ...
                                                    <input type="text" min="0" name="price" class="form-control" value="{{ $event->price }}" placeholder="10.000" id="price" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group input-group-lg input-group-solid date" id="kt_datetimepicker_custom_1" data-target-input="nearest">
                                                    <input type="text" name="start" class="form-control datetimepicker-input" value="{{ $event->start }}" placeholder="Pilih tanggal dan waktu" data-target="#kt_datetimepicker_custom_1" required/>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9 col-xl-6">
                                                <div class="input-group input-group-lg input-group-solid date" id="kt_datetimepicker_custom_2" data-target-input="nearest">
                                                    <input type="text" name="end" class="form-control datetimepicker-input" value="{{ $event->end }}" placeholder="Pilih tanggal dan waktu" data-target="#kt_datetimepicker_custom_2" required/>
...
@push('script')
    ...
    <script>
        var KTLeaflet = function () {
            ...
            // Private functions
            var demo5 = function () {
                var leaflet = L.map('leaflet_event_add').setView([{{ $event->map }}], 16);
                ...
                // L.marker({{ $event->map }}, { icon: leafletIcon }).addTo(markerLayer);
                L.marker([{{ $event->map }}], { icon: leafletIcon }).addTo(markerLayer);
