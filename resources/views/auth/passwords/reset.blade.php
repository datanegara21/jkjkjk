                ...
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    ...
                    <div class="login-forgot">
                        <div class="mb-20">
                            <h3>Ubah Pasword</h3>
                            <p class="opacity-60">
                                Masukkan password baru yang akan digunakan.
                            </p>
                        </div>
                        <form method="POST" action="{{ route('password.update') }}" class="form" id="kt_login_forgot_form">
                            ...
                            <div class="form-group mb-10">
                                <input
                                    ...
                                    type="email" placeholder="password konfirmasi" name="email" value="{{ $email }}" required autocomplete="off" />
                            </div>
                            <div class="form-group mb-10">
                                <input
                                    class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8"
                            ...
                            <div class="form-group mb-10">
                                <input
                                    class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8"
                                    type="password" placeholder="password konfirmasi" name="password_confirmation" required autocomplete="off" />
                            </div>
